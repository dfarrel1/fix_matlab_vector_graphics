### Orinally Acquired from (https://github.com/Sbte/fix_matlab_eps/blob/master/fix_matlab_eps.py)
### Original Author: Sven Baars.
...
def main():
    pathvar = subprocess.call('$PATH', shell=True)
    ##print pathvar
    ...
    ## FOR TESTING - HARDCODE THE LOCATION (FULL PATH) OF A FILE HERE
    ## AND UNCOMMENT THESE LINES
    ##file1 = <full-path-to-eps-file>
    tmp = os.path.join(tempfile.gettempdir(), 'fix_matlab_eps.eps')
    ##print 'inkscape --export-area-page --export-eps=' +tmp+' '+sys.argv[1]
    ##ret = subprocess.call('inkscape ' + file1, shell=True)
